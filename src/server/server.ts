...
export class AppiumMCPServer {
    ...
    private setupToolHandlers() {
        ...
        this.server.setRequestHandler(CallToolRequestSchema, async (request) => {
            ...
            try {
                // Initialize Appium client if not already done
                ...
                const result = await executeToolMethod(this.appiumClient, name, args || {});
    ...
    async run() {
        ...
        console.log("Appium MCP Server running on stdio");
    }
}
